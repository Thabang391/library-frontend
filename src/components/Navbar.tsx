...
export default function Navbar() {
  ...
  // Premium link styling – dark glass variant
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/10 backdrop-blur-xl border-b border-white/10">
          ...
          <div className="hidden md:flex items-center gap-4">
            {user ? (
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-3 px-2 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-white/10">
      ...
      {/* Mobile Dropdown Menu – Dark Glass */}
      {mobileOpen && (
